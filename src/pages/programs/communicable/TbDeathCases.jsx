...
const TbDeathCases = () => {
    return (
        <div className="home-wrapper animate-enter">
            <PageHeader
                title="TB Death Cases"
                subtitle="Unfortunate Outcomes"
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', height: '50vh', textAlign: 'center', opacity: 0.7 }}>
                ...
                <p style={{ color: 'var(--text-muted)', fontSize: '0.9rem' }}>No TB-related deaths reported.</p>
            </div>
        </div>
    );
};
export default TbDeathCases;
